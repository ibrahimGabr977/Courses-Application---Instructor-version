...
public class StatisticsRecyclerAdapter extends RecyclerView.Adapter<StatisticsRecyclerAdapter.StatisticsViewHolder> {
    ...
    @NonNull
    @Override
    public StatisticsRecyclerAdapter.StatisticsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull StatisticsRecyclerAdapter.StatisticsViewHolder holder, int position) {
