package com.hope.igb.elqalam_teacher.screens.mainscreen.statistics;
...
import com.hope.igb.elqalam_teacher.networking.models.Statistic;
...
public class StatisticsFragment extends Fragment {
    ...
    private void initTestData() {
        ...
        Statistic statistic1 = new Statistic(getString(R.string.statistic_title_test1),
                getString(R.string.statistic_value_test1), getString(R.string.statistic_date_test1));


        Statistic statistic2 = new Statistic(getString(R.string.statistic_title_test2),
                getString(R.string.statistic_value_test2), getString(R.string.statistic_date_test2));


        Statistic statistic3 = new Statistic(getString(R.string.statistic_title_test3),
                getString(R.string.statistic_value_test3), getString(R.string.statistic_date_test3));


        Statistic statistic4 = new Statistic(getString(R.string.statistic_title_test4),
                getString(R.string.statistic_value_test4), getString(R.string.statistic_date_test4));


        Statistic statistic5 = new Statistic(getString(R.string.statistic_title_test5),
                getString(R.string.statistic_value_test5), getString(R.string.statistic_date_test5));



        Statistic statistic6 = new Statistic(getString(R.string.statistic_title_test6),
                getString(R.string.statistic_value_test6), getString(R.string.statistic_date_test6));
